...
As in \cref{section:results:assertVoting}, we split our findings into the results for election types with linearly many ballot entries and the results for election types with quadratically many ballot entries depending on the number of candidates.
