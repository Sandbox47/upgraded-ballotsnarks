...
\begin{Algorithmus}[h] %Use the environment only if you want to place the algorithm similar to graphics from TeX
    ...
    \Procedure{$TangentRule$}{$[X:Y:Z]$}
        \State $I:=3X^2+2AXZ+Z^2$
        \State $H:=2BYZ$
        \State $X':=BI^2HZ^2-(AZ^2+2XZ)H^3$
        \State $Y':=-BI^3Z^2+(AZ^2+3XZ)IH^2-YZH^3$
        \State $Z':=H^3Z^2$
        \State \Return $[X':Y':Z']$
    \EndProcedure
    \end{algorithmic}
...
\begin{Algorithmus}[h] %Use the environment only if you want to place the algorithm similar to graphics from TeX
    ...
    \Procedure{$ChordRule$}{$[X_1:Y_1:Z_1], [X_2:Y_2:Z_2]$}
        \State $I:=Y_2Z_1-Y_1Z_2$
        \State $H:=X_2Z_1-X_1Z_2$
        \State $X':=BI^2HZ_1Z_2-(AZ_1Z_2+X_1Z_2+X_2Z_1)H^3$
        \State $Y':=-BI^3Z_1Z_2+(AZ_1Z_2+2X_1Z_2+X_2Z_1)IH^2-Y_1Z_2H^3$
        \State $Z':=H^3Z^2$
        \State \Return $[X':Y':Z']$
    \EndProcedure
    \end{algorithmic}
