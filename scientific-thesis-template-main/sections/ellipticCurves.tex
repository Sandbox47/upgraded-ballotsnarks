...
\todo{
    Better introduction of group exponentiation (via $g^m=\sum\limits_{i=0}^l \left(g^{2^i}\right)^{m_i}$). 
    Use this to introduce idea for exponentiation using precomputed powers of $g$.
