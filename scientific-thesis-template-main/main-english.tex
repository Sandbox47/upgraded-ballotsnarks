...
\chapter{Ballots in Elections}
\begin{itemize}
  \item Voters submit a ballot with a specific format (-> Choice space) 
  \item Ballot gets encrypted (semi-homomorphic encryption scheme) before being passed to the voting authority
  \item Voting authority does some computations on encrypted ballots and outputs decrypted tally
\end{itemize}


\chapter{Proving Ballot Validity}
